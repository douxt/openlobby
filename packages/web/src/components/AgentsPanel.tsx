...
export default function AgentsPanel({ onClose, highlightId }: Props) {
  ...
  return (
    ...
    >
      <div
        className="bg-gray-900 rounded-xl p-6 w-full max-w-2xl border border-gray-700 max-h-[80dvh] overflow-y-auto w-[calc(100vw-32px)] md:w-96 mx-4 md:mx-0 flex flex-col"
